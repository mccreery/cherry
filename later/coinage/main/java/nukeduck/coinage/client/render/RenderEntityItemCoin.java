...
public class RenderEntityItemCoin extends Render {
    ...
    public RenderEntityItemCoin(RenderManager p_i46167_1_, RenderItem p_i46167_2_) {
        super(p_i46167_1_);
    ...
    private int func_177077_a(EntityItem p_177077_1_, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
        ...
        else
        {
            ...
            GlStateManager.translate((float)p_177077_2_, (float)p_177077_4_ + f2 + 0.15F, (float)p_177077_6_);
            float f3;
            
            if (flag || this.renderManager.options != null && this.renderManager.options.fancyGraphics)
            {
                f3 = (((float)p_177077_1_.getAge() + p_177077_8_) / 5.0F + p_177077_1_.hoverStart) * (180F / (float)Math.PI);
                GlStateManager.rotate(f3, 0.0F, 1.0F, 0.0F);
            }
            
            //////////////////////////////////////////
            if(itemstack.getItem() == Coinage.instance.itemRegister.coin && itemstack.getItemDamage() == 2) {
