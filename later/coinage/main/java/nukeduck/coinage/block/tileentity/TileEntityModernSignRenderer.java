package nukeduck.gmasign.block.tileentity;
...
public class TileEntityModernSignRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147513_b = new ResourceLocation("gmasign", "textures/entity/modern_sign.png");
    ...
    public void func_180541_a(TileEntitySign p_180541_1_, double p_180541_2_, double p_180541_4_, double p_180541_6_, float p_180541_8_, int p_180541_9_)
    {
        ...
        if (block == GMASBlocks.standingModernSign)
        {
