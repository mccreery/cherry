...
public class ModelLightsaberCDouble extends ModelBaseLightsaber {
	ModelRenderer base;
	...
	ModelRenderer indentB;
	ModelRenderer emitterB;
	ModelRenderer sidePanelB;
	
	public ModelLightsaberCDouble() {
		this.bladeOffset = 13;
		this.doubledOffset = 38;
		...
		indentB = new ModelRenderer(this, 4, 0);
		indentB.addBox(0F, 0F, 0F, 2, 1, 2);
		indentB.setRotationPoint(-1F, 23F, -1F);
		indentB.setTextureSize(32, 64);
		indentB.mirror = true;
		setRotation(indentB, 0F, 0F, 0F);
		emitterB = new ModelRenderer(this, 0, 8);
		emitterB.addBox(0F, 0F, 0F, 3, 1, 3);
		emitterB.setRotationPoint(-1.5F, 24F, -1.5F);
		emitterB.setTextureSize(32, 64);
		emitterB.mirror = true;
		setRotation(emitterB, 0F, 0F, 0F);
		sidePanelB = new ModelRenderer(this, 10, 15);
		sidePanelB.addBox(0F, 0F, 0F, 1, 2, 2);
		sidePanelB.setRotationPoint(-2F, 21.5F, -1F);
		sidePanelB.setTextureSize(32, 64);
		sidePanelB.mirror = true;
		setRotation(sidePanelB, 0F, 0F, 0F);
	}
