...
public class ModelLightsaberBDouble extends ModelBaseLightsaber {
	...
	ModelRenderer coneB2;
	ModelRenderer coneB3;
	ModelRenderer coneB4;
	
	public ModelLightsaberBDouble() {
		this.bladeOffset = 12;
		...
		baseRing.setRotationPoint(-2F, 20F, -2F);
		...
		upperRing.setRotationPoint(-2F, 16F, -2F);
		...
		lowerButton.setRotationPoint(1.5F, 19.5F, -0.5F);
		...
		emitter1.setRotationPoint(-1F, 15F, -1F);
		...
		sidePanel.setRotationPoint(-2.5F, 16.5F, -1F);
		sidePanel.setTextureSize(32, 64);
		sidePanel.mirror = true;
		setRotation(sidePanel, 0F, 0F, 0F);
		coneB1 = new ModelRenderer(this, 28, 32);
		coneB1.addBox(0F, 0F, 0F, 1, 1, 1);
		coneB1.setRotationPoint(-0.5F, 22F, -0.5F);
		coneB1.setTextureSize(32, 64);
		coneB1.mirror = true;
		setRotation(coneB1, 0F, 0F, 0F);
		coneB2 = new ModelRenderer(this, 24, 29);
		coneB2.addBox(0F, 0F, 0F, 2, 1, 2);
		coneB2.setRotationPoint(-1F, 23F, -1F);
		coneB2.setTextureSize(32, 64);
		coneB2.mirror = true;
		setRotation(coneB2, 0F, 0F, 0F);
		coneB3 = new ModelRenderer(this, 20, 25);
		coneB3.addBox(0F, 0F, 0F, 3, 1, 3);
		coneB3.setRotationPoint(-1.5F, 23.5F, -1.5F);
		coneB3.setTextureSize(32, 64);
		coneB3.mirror = true;
		setRotation(coneB3, 0F, 0F, 0F);
		coneB4 = new ModelRenderer(this, 16, 20);
		coneB4.addBox(0F, 0F, 0F, 4, 1, 4);
		coneB4.setRotationPoint(-2F, 24F, -2F);
		coneB4.setTextureSize(32, 64);
		coneB4.mirror = true;
		setRotation(coneB4, 0F, 0F, 0F);
	}
